...
public class SequenceQuiz : Quiz
{
    ...
    public override bool CheckQuestionAnswer()
    {
        ...
        {
            if (answer[i] != Array.IndexOf(selectObjects, draggableObjects[i].gameObject))
            {
    ...
    public void OnDisable()
    {
        ...
        if (SectionAndBackGroundManager.Instance != null)
    ...
    private void AutoSolve()
    {
        ...
        {
            selectObjects[i] = draggableObjects[answer[i]].gameObject;
            draggableObjects[i].position = targetObjects[answer[i]].transform.position;
        }
    }
